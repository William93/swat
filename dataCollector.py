...
PLC_IPS = {
    'plc1': '192.168.1.10',
    # 'tag_plc1':['HMI_FIT101.Pv', 'HMI_LIT101.Pv', 'HMI_FIT201.Pv', 'HMI_P1_STATE', 'HMI_P101.Status', 'HMI_MV101.Status'],
...
var_name_plc2 = ["\'HMI_AIT201.SAHH\'", "\'HMI_AIT201.SAH\'", "\'HMI_AIT201.SAL\'", "\'HMI_AIT201.SALL\'",
                 "\'HMI_AIT202.SAHH\'", "\'HMI_AIT202.SAH\'", "\'HMI_AIT202.SAL\'", "\'HMI_AIT202.SALL\'",
                 "\'HMI_AIT203.SAHH\'", "\'HMI_AIT203.SAH\'", "\'HMI_AIT203.SAL\'", "\'HMI_AIT203.SALL\'"]
...
insert = """INSERT INTO data01(Transaction_id, Tag_Name, Tag_Value)
            VALUES ({0}, {1}, {2});"""
...
for h in range(10):
    ...
    print(array1)
    for j in range(8):    
            cur.execute(insert.format(1, var_name_plc1[j], array1[j][1]))
            print(var_name_plc1[j])
            print(array1[j][1])

    connect.commit()
    SPCchecker.check()
    cur.execute("DELETE FROM data01 WHERE Transaction_id=1") # delete the data set if there is no anomaly
